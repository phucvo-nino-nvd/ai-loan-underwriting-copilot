...
export function MetricCard({
  ...
  return (
    <div
      className="group relative bg-card/40 border border-border/60 p-4 sm:p-5 hover:border-accent/40 transition-all duration-300 overflow-hidden animate-in fade-in slide-in-from-bottom-4"
    ...
    >
      ...
      <div className="relative">
        <div className="flex items-start justify-between mb-3">
          <span className="text-[11px] uppercase tracking-wider font-bold text-foreground leading-snug pr-2 text-balance">
            {title}
          </span>
        ...
        <div className="flex items-end gap-3">
          <span className="text-2xl lg:text-3xl font-bold text-foreground tracking-tight tabular">
            {value}
          </span>
          <div
            className={cn(
