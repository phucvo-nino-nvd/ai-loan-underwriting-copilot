  ...
  const principles = [
    {
      ...
      description: "Ensemble ML with SHAP explainability — scores are accurate, and every factor is traceable.",
      align: "left",
    },
    {
      number: "02",
      ...
      description: "Every recommendation comes with clear explanations — so you always know the why behind the score.",
      align: "right",
    },
    {
      number: "03",
      titleParts: [
        { text: "ADVISORY", highlight: true },
        { text: " ML", highlight: false },
      ],
      description: "The model predicts and explains. The underwriter owns every credit decision.",
      align: "left",
    },
    {
      number: "04",
      ...
      description: "Assess, review, chat with policy — all from a single interface designed for underwriters.",
      align: "right",
    },
  ]
  ...
  return (
    <section ref={sectionRef} id="principles" className="relative py-32 pl-6 md:pl-28 pr-6 md:pr-12">
      ...
      <div ref={headerRef} className="mb-24">
        ...
        <h2 className="mt-4 font-[family-name:var(--font-bebas)] text-5xl md:text-7xl tracking-tight">HOW WE WORK</h2>
      </div>
      ...
      <div ref={principlesRef} className="space-y-24 md:space-y-32">
        {principles.map((principle, index) => (
          ...
          >
            ...
            <h3 className="font-[family-name:var(--font-bebas)] text-4xl md:text-6xl lg:text-8xl tracking-tight leading-none">
              {principle.titleParts.map((part) =>
                part.highlight ? (
                  <HighlightText key={part.text} parallaxSpeed={0.6}>
                    {part.text}
                  </HighlightText>
                ) : (
